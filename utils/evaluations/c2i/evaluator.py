...
def main():
    ...
    parser.add_argument("--ref_batch", default="utils/evaluations/c2i/VIRTUAL_imagenet256_labeled.npz", help="path to reference batch npz file")
    parser.add_argument("--sample_batch", default="utils/evaluations/c2i/admnet_upsampled_imagenet256.npz", help="path to sample batch npz file")
    args = parser.parse_args()
    if "shape512" in args.sample_batch:
        args.ref_batch = "utils/evaluations/c2i/VIRTUAL_imagenet512.npz"
